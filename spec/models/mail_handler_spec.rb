    ...
    context 'when sending a reply to work package mail' do
      ...
      context 'with a custom field' do
        ...
        before do
          ...
          type.save!
          # rubocop:disable RSpec/AnyInstance: Avoid stubbing using allow_any_instance_of.
          allow_any_instance_of(WorkPackage).to receive(:available_custom_fields).and_return([custom_field])
          # rubocop:enable RSpec/AnyInstance: Avoid stubbing using allow_any_instance_of.
